...
class TodoItemData extends DataClass implements Insertable<TodoItemData> {
  ...
  TodoItemData copyWith(
          {int? id, String? title, String? description, DateTime? limitDate}) =>
      TodoItemData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, title, description, limitDate);
  @override
...
class $TodoItemTable extends TodoItem
  ...
  @override
  List<GeneratedColumn> get $columns => [id, title, description, limitDate];
  @override
